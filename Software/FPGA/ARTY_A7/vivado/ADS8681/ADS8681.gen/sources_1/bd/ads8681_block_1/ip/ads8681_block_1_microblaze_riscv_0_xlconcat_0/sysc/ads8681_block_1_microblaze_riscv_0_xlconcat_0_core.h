...
#ifndef _ads8681_block_1_microblaze_riscv_0_xlconcat_0_core_h_
#define _ads8681_block_1_microblaze_riscv_0_xlconcat_0_core_h_
...
class ads8681_block_1_microblaze_riscv_0_xlconcat_0_core : public sc_module 
{
    public: 
       ads8681_block_1_microblaze_riscv_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(ads8681_block_1_microblaze_riscv_0_xlconcat_0_core);
    ...
    virtual ~ads8681_block_1_microblaze_riscv_0_xlconcat_0_core() = default;
